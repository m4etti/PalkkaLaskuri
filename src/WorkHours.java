...
public class WorkHours implements Serializable {
     ...
     * 
     */
    public WorkHours(double normal, double evening, double nigth, double overTimeNormal, double overTimeEvening,
            double overTimeNigth) {
        this.normal = normal;
        this.evening = evening;
        this.night = nigth;
        this.overTimeNormal = overTimeNormal;
        this.overTimeEvening = overTimeEvening;
        this.overTimeNight = overTimeNigth;
    }
